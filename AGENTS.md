...
## Local Ollama Image Vision

Siftly can run the **image vision**, **semantic enrichment**, and **categorization** preprocessing steps through Ollama while keeping AI search on Anthropic/Claude.
